...
class MyRob(CRobLinkAngs):
    ...
    def wander(self):
        ...
        print("MEASURES_TIME", self.measures.time)
        ...
        print("TIME->", time)
        print("already_in_turnAround_Condition->", already_in_turnAround_Condition)
        print("bussola_turnAround->", bussola_turnAround)
        ...
        if pathLeft == ['0'] and pathRight == ['0']:    #Exprimentar isto no final dos if's. Secalhar meter este if = [0,0,1,1,1,0,0]
            ...
            #TESTAR!! Tb tem de se fazer isto para o WE KNOW LS e o WE KNOW RS e no lets turn left e no lets turn right tb porque as vezes, por causa da diferença do x's, ele vira antes de encontrar 1's
            #DIMINUIR A DIFERENÇA DO X/Y PARA VIRAR À ESQUERDA/DIREITA   
